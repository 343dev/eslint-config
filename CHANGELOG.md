...
- `@stylistic/indent-binary-ops` rule (tab indentation for binary operators)

### Changed

- **BREAKING:** Minimum Node.js version is now 22
- **BREAKING:** Minimum ESLint version is now 10.5.0

## [4.0.0] - 2026-01-01

### Changed

- **BREAKING:** New ESLint config
- **BREAKING:** Minimum Node.js version is now 20.10
- **BREAKING:** Minimum ESLint version is now 9.39.2
